...
const char *error_msgs[] = {
    ...
    [SEMANTIC_ERR_FUNC] = "Semantic error: undefined function, redefied variable",
    [SEMANTIC_ERR_CALL] = "Semantic error: wrong number of arguments, wrong argument type, wrong return type",
