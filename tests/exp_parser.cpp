...
TEST_F(ExpParserTest, ParenthesisTests) {
  Token expresion[]
      = {{TOKEN_LPAREN, KW_UNKNOWN, "(", 2}, {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},
         {TOKEN_PLUS, KW_UNKNOWN, "+", 2},   {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},
         {TOKEN_RPAREN, KW_UNKNOWN, ")", 2}, {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
  ASSERT_EQ(parse_expression(expresion, 6, &parser_).type, TOKEN_EXPRESSION);

  Token expresion1[]
      = {{TOKEN_LPAREN, KW_UNKNOWN, "(", 2},       {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},
         {TOKEN_PLUS, KW_UNKNOWN, "+", 2},         {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},
         {TOKEN_RPAREN, KW_UNKNOWN, ")", 2},       {TOKEN_RPAREN, KW_UNKNOWN, ")", 2},
         {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
  EXPECT_EXIT(parse_expression(expresion1, 7, &parser_), ::testing::ExitedWithCode(SYNTAX_ERR),
              ".*");

  Token expresion2[]
      = {{TOKEN_LPAREN, KW_UNKNOWN, "(", 2},           {TOKEN_LPAREN, KW_UNKNOWN, "(", 2},
...
TEST_F(ExpParserTest, BasicTests2) {
  ...
  Token expresion2[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},
                        {TOKEN_PLUS, KW_UNKNOWN, "+", 0},
                        {TOKEN_STRING_LITERAL, KW_UNKNOWN, "42", 2},
                        {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
  EXPECT_EXIT(parse_expression(expresion2, 4, &parser_),
