...
TEST_F(ExpParserTest, BasicTests) { 
    ...
    ASSERT_EQ(parse_expression(expresion2, 4, &parser_, stack2).type, TOKEN_EXPRESSION);
    ...
    EXPECT_EXIT(parse_expression(expresion3, 3, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
    ...
    ASSERT_EQ(parse_expression(expresion4, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);
...
TEST_F(ExpParserTest, MinusTests) {
    ...
    ASSERT_EQ(parse_expression(expresion1, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);

    Token expresion2[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2}, {TOKEN_MINUS, KW_UNKNOWN, "-", 2} , {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
    EXPECT_EXIT(parse_expression(expresion2, 3, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
}
...
TEST_F(ExpParserTest, LowerOrEqualsTests) {
    Token expresion1[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2}, {TOKEN_LTE, KW_UNKNOWN, "<=", 0} , {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2}, {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
    ASSERT_EQ(parse_expression(expresion1, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);

    Token expresion2[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},{TOKEN_LTE, KW_UNKNOWN, "<=", 0} , {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0}};
    EXPECT_EXIT(parse_expression(expresion2, 3, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
}
...
TEST_F(ExpParserTest, GreaterOrEqualsTests) {
    Token expresion1[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},{TOKEN_GTE, KW_UNKNOWN, "<=", 1}, {TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2}, {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0},};
    ASSERT_EQ(parse_expression(expresion1, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);

        Token expresion2[] = {{TOKEN_INTEGER_LITERAL, KW_UNKNOWN, "42", 2},{TOKEN_GTE, KW_UNKNOWN, "<=", 1},  {TOKEN_STACK_BOTTOM, KW_UNKNOWN, NULL, 0},};
...
TEST_F(ExpParserTest, ParenthesisTests) {
    ...
    ASSERT_EQ(parse_expression(expresion, 6, &parser_, stack_new(50)).type, TOKEN_EXPRESSION );
    ...
    EXPECT_EXIT(parse_expression(expresion1, 7, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
    ...
    EXPECT_EXIT(parse_expression(expresion2, 7, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
}
...
TEST_F(ExpParserTest, OtaznickyTests) {
    ...
    ASSERT_EQ(parse_expression(expresion, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);
}
...
TEST_F(ExpParserTest, VykricnikyTests) {
    ...
    ASSERT_EQ(parse_expression(expresion1, 3, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);
}
...
TEST_F(ExpParserTest, NilTests) {
    ...
    ASSERT_EQ(parse_expression(expresion2, 3, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);
    ...
    ASSERT_EQ(parse_expression(expresion3, 4, &parser_, stack_new(50)).type, TOKEN_EXPRESSION);
...
TEST_F(ExpParserTest, BasicTests2) { 
    ...
    EXPECT_EXIT(parse_expression(expresion2, 4, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
...
TEST_F(ExpParserTest, JardaPepik) { 
    ...
    EXPECT_EXIT(parse_expression(expresion1, 8, &parser_, stack_new(50)), ::testing::ExitedWithCode(SYNTAX_ERR), ".*");
