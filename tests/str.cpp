...
//   EXPECT_EQ(strcmp(str_new_int_const("18945611891958")->data,
//   "int@18945611891958"), 0);

//   EXPECT_EQ(strcmp(str_new_float_const("0.152391849123")->data,
//   "float@0x1.381937c14831dp-3"), 0);
